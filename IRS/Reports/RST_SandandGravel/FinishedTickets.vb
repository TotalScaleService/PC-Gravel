...
Public Class FinishedTickets
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IRS.FinishedTickets.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinishedTickets
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FinishedTickets = New FinishedTickets()
        rpt.Site = Me.Site
        Return rpt
    End Function
