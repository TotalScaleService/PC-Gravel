...
Public Class ProductByTicket
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IRS.ProductByTicket.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProductByTicket
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProductByTicket = New ProductByTicket()
        rpt.Site = Me.Site
        Return rpt
    End Function
